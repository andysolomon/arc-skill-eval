...
## Status
Bootstrapping repo foundation, planning artifacts, contract loading/normalization, hermetic fixture materialization, initial Pi SDK runner + session telemetry + canonical trace normalization, deterministic scoring, JSON-first reporting with optional HTML rendering, library-backed CLI commands, CLI golden parity coverage, and semantic-release automation.
